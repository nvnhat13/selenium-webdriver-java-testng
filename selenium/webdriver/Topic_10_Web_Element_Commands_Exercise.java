...
//@Test
	public void TC_01_Displayed() {
		...
		if (driver.findElement(By.xpath("//div[@class='container']//textarea[@id='edu']")).isDisplayed()) {
			driver.findElement(By.xpath("//div[@class='container']//textarea[@id='edu']"))
...
//@Test
	public void TC_03_Selected() {
		...
		// isSelected(): nếu 1 element được chọn thành công nó sẽ trả về True, còn chưa
		// chọn thì sẽ trả về False
	}
